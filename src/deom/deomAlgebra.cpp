...
void deom::oprAct(cx_cube &d_ddos, const mat &sdip, const cx_cube &ddos, const char lrc) {
...
void deom::iniHei(cx_cube &oprs, const mat &sdip) {
...
cx_mat deom::get_superOpr(const cx_mat &Opr) {
