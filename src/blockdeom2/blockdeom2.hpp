...
public:
  ...
  blockdeom2(const syst &s, const bath &b, const hidx &h, const char lc, const char rc) : syst(s), bath(b), hidx(h) {
    ng = 1;
    ne = ham1.n_rows;
    nf = ne * (ne - 1) / 2;
  ...
  blockdeom2(const blockdeom2 &rhs, const char lc, const char rc) : syst(rhs.ham1, rhs.qmd1),
  ...
  blockdeom2(const blockdeom2 &rhs, const cx_mat &hl, const cx_mat &hr, const cx_cube &ql, const cx_cube &qr, const char lc, const char rc) : syst(hl, hr, ql, qr),
                                                                                                                                              bath(rhs.temperature, rhs.modLabel, rhs.coef_lft, rhs.coef_rht, rhs.coef_abs, rhs.expn_gam, rhs.delt_res, rhs.alpha1, rhs.alpha2),
                                                                                                                                              hidx(rhs.nind, rhs.lmax, rhs.nmax, rhs.lddo, rhs.nddo,
                                                                                                                                                   rhs.ferr, rhs.keys, rhs.tree, rhs.expn) {
    ddos1.set_size(nl, nr, nmax);
