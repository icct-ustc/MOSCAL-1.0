...
void corr3rdPP2_monomer(const double w1_max, const double t2_max, const double w3_max,
  ...
  blockdeom2 d1_eg(s, b, h, 'e', 'g');
  blockdeom2 d1_ge(s, b, h, 'g', 'e');
  ...
  d1_eg.iniSch(rho_t1_eg, sdip_eg);
  d1_ge.iniSch(rho_t1_ge, sdip_ge);

  if (sch_hei == 's') { // sch-pic

    for (int it1 = 0; it1 < nt1; ++it1) {

      blockdeom2 d2_ee1(d1_eg, 'e', 'e');
      blockdeom2 d2_ee2(d1_ge, 'e', 'e');
      blockdeom2 d2_gg2(d1_ge, 'g', 'g');
      blockdeom2 d2_gg1(d1_eg, 'g', 'g');
      ...
      d2_ee1.oprAct(rho_t2_ee1, sdip_ge, rho_t1_eg, 'r');
      d2_ee2.oprAct(rho_t2_ee2, sdip_eg, rho_t1_ge, 'l');
      d2_gg2.oprAct(rho_t2_gg2, sdip_eg, rho_t1_ge, 'r');
      d2_gg1.oprAct(rho_t2_gg1, sdip_ge, rho_t1_eg, 'l');

      for (int it2 = 0; it2 < nt2; ++it2) {

        blockdeom2 d3_r1(d2_ee1, 'e', 'g');
        blockdeom2 d3_r2(d2_ee2, 'e', 'g');
        blockdeom2 d3_r3(d2_gg2, 'e', 'g');
        blockdeom2 d3_r4(d2_gg1, 'e', 'g');
        ...
        d3_r1.oprAct(rho_t3_r1, sdip_eg, rho_t2_ee1, 'r');
        d3_r2.oprAct(rho_t3_r2, sdip_eg, rho_t2_ee2, 'r');
        d3_r3.oprAct(rho_t3_r3, sdip_eg, rho_t2_gg2, 'l');
        d3_r4.oprAct(rho_t3_r4, sdip_eg, rho_t2_gg1, 'l');

        for (int it3 = 0; it3 < nt3; ++it3) {

          R1(it3, it1, it2) = d3_r1.Trace(sdip_ge, rho_t3_r1);
          R2(it3, it1, it2) = d3_r2.Trace(sdip_ge, rho_t3_r2);
          R3(it3, it1, it2) = d3_r3.Trace(sdip_ge, rho_t3_r3);
          R4(it3, it1, it2) = d3_r4.Trace(sdip_ge, rho_t3_r4);
