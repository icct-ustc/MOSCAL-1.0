...
void deom2::oprAct(cx_cube &d_ddos, const mat &sdip, const cube &pdip, const vec &bdip, const cx_cube &ddos, const char lrc) {
...
void deom2::iniHei(cx_cube &oprs, const mat &sdip, const cube &pdip, const vec &bdip) {
